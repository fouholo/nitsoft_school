<div>
    <h1 class="text-2xl font-semibold text-stone-900">Journal SMS</h1>
        ...
        <table class="min-w-full divide-y divide-stone-200 text-sm">
            <thead class="bg-stone-50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left font-medium text-stone-500">Destinataire</th>
            ...
            <tbody class="divide-y divide-stone-100">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-4 py-6 text-center text-stone-500">Aucun SMS envoyé.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
