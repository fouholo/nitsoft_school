<div>
    ...
    <p class="mt-4 text-sm text-stone-500">Une composition est commune à toutes les classes du primaire.</p>
        ...
        <table class="min-w-full divide-y divide-stone-200 text-sm">
            <thead class="bg-stone-50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left font-medium text-stone-500">Composition</th>
            ...
            <tbody class="divide-y divide-stone-100">
                @forelse ($gradeSheets as $gradeSheet)
                    <tr wire:key="grade-sheet-{{ $gradeSheet->id }}">
                        ...
                        <td class="px-4 py-2 text-stone-600">Composition {{ $gradeSheet->composition_number }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-4 py-6 text-center text-stone-500">Aucune composition.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
