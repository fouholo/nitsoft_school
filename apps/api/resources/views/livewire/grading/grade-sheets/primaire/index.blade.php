<div>
    ...
    <p class="mt-4 text-sm text-slate-500">Une composition est commune à toutes les classes du primaire.</p>
    ...
    <div class="mt-6 overflow-hidden rounded-md border border-slate-200 bg-white">
        <table class="min-w-full divide-y divide-slate-200 text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-4 py-6 text-center text-slate-500">Aucune composition.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
