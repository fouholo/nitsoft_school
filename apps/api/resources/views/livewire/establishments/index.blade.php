<div>
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-stone-900">Établissements</h1>
    ...
    @if ($showForm)
        <form wire:submit="save" class="mt-4 grid grid-cols-1 gap-4 rounded-lg border border-stone-200 bg-white p-4 sm:grid-cols-4">
            ...
            <div>
                <label class="block text-sm font-medium text-stone-700">Fondation</label>
            ...
            <div>
                <label class="block text-sm font-medium text-stone-700">Inspection</label>
            ...
            <div>
                <label class="block text-sm font-medium text-stone-700">Code d'ouverture</label>
            ...
            <div>
                <label class="block text-sm font-medium text-stone-700">Code DSPS</label>
            ...
            <div>
                <label class="block text-sm font-medium text-stone-700">Latitude</label>
                <input type="text" wire:model="latitude" class="mt-1 block w-full rounded-lg border-stone-300 text-sm">
                @error('latitude') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
            </div>

            <div>
                <label class="block text-sm font-medium text-stone-700">Longitude</label>
        ...
        <table class="min-w-full divide-y divide-stone-200 text-sm">
            <thead class="bg-stone-50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left font-medium text-stone-500">Fondation</th>
            ...
            <tbody class="divide-y divide-stone-100">
                    ...
                    <tr wire:key="establishment-{{ $establishment->id }}">
                        ...
                        <td class="px-4 py-2 text-right">
                            @can('update', $establishment)
                                <button wire:click="edit({{ $establishment->id }})" class="text-stone-500 hover:text-stone-900">Modifier</button>
                            @endcan
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-6 text-center text-stone-500">Aucun établissement.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
