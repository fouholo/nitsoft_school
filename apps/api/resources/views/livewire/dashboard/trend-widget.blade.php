<div class="mt-4 rounded-2xl border border-stone-200 bg-white p-5">
    <p class="text-sm font-semibold uppercase tracking-wide text-stone-500">Tendance des encaissements</p>
    ...
    @else
        <div class="mt-3 flex items-baseline gap-3">
            ...
            <p class="text-xs text-stone-500">ce mois-ci</p>

            @if ($deltaPercent !== null)
                <span class="ml-auto text-sm font-medium {{ $deltaAmount >= 0 ? 'text-emerald-700' : 'text-red-700' }}">
        ...
        <p class="mt-1 text-xs text-stone-500">{{ money($previousCollected) }} le mois précédent</p>
    @endif
</div>
