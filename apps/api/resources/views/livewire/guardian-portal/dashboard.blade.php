<div>
    <h1 class="text-2xl font-semibold text-stone-900">Mes enfants</h1>
        ...
        @empty
            @if ($pendingCount === 0)
                <p class="text-stone-500">
                    ...
                    <a href="{{ route('guardian-portal.link-child') }}" wire:navigate class="text-orange-700 hover:underline">Lier un enfant</a>
                </p>
            @endif
        @endforelse
    </div>
