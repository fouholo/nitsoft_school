<div>
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-stone-900">Années scolaires</h1>
        ...
        <table class="min-w-full divide-y divide-stone-200 text-sm">
            <thead class="bg-stone-50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left font-medium text-stone-500">Courante</th>
            ...
            <tbody class="divide-y divide-stone-100">
                    ...
                    <tr wire:key="school-year-{{ $schoolYear->id }}">
                        ...
                        <td class="px-4 py-2 text-right">
                            @can('update', $schoolYear)
                                <button wire:click="edit({{ $schoolYear->id }})" class="text-stone-500 hover:text-stone-900">Modifier</button>
                            @endcan
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-4 py-6 text-center text-stone-500">Aucune année scolaire.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
